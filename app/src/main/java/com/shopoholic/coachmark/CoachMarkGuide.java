...
public class CoachMarkGuide {
    ...
    /* Static builder */
    public static CoachMarkGuide init(Activity activity){
        return new CoachMarkGuide(activity);
    }

    /* Constructor */
    public CoachMarkGuide(Activity activity){
        mActivity = activity;
    }
     ...
     * @return return CoachMarkGuide instance for chaining purpose
     */
    public CoachMarkGuide with(Technique technique) {
     ...
     * @return return CoachMarkGuide instance for chaining purpose
     */
    public CoachMarkGuide motionType(MotionType motionType){
        mMotionType = motionType;
        return this;
    }

    /**
     * Sets the targeted view for CoachMarkGuide to play on
     * @param targetView the view in which the tutorial button will be placed on top of
     * @return return CoachMarkGuide instance for chaining purpose
     */
    public CoachMarkGuide playOn(View targetView){
     ...
     * @return return CoachMarkGuide instance for chaining purpose
     */
    public CoachMarkGuide setOverlay(Overlay overlay){
        mOverlay = overlay;
        return this;
    }
    /**
     ...
     * @return return CoachMarkGuide instance for chaining purpose
     */
    public CoachMarkGuide setToolTip(ToolTip toolTip){
        mToolTip = toolTip;
        return this;
    }
    /**
     ...
     * @return return CoachMarkGuide instance for chaining purpose
     */
    public CoachMarkGuide setPointer(Pointer pointer){
        mPointer = pointer;
        return this;
    }
    /**
    ...
    protected void setupView(){
        // CoachMarkGuide can only be setup after all the views is ready and obtain it's position/measurement
        // so when this is the 1st time CoachMarkGuide is being added,
        // else block will be executed, and ViewTreeObserver will make CoachMarkGuide setup process to be delayed until everything is ready
    ...
    private void setupToolTip(){
        ...
        if (mToolTip != null) {
            ...
            if (mToolTip.getCustomView() == null) {
                mToolTipViewGroup = layoutInflater.inflate(R.layout.coachmark_tooltip, null);

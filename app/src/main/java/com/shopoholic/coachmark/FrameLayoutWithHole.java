...
public class FrameLayoutWithHole extends FrameLayout {
    ...
    private CoachMarkGuide.MotionType mMotionType;
    ...
    private void enforceMotionType() {
        ...
        if (mViewHole != null) {
            ...
            if (mMotionType != null && mMotionType == CoachMarkGuide.MotionType.CLICK_ONLY) {
            ...
            } else if (mMotionType != null && mMotionType == CoachMarkGuide.MotionType.SWIPE_ONLY) {
    ...
    public FrameLayoutWithHole(Activity context, View view) {
        this(context, view, CoachMarkGuide.MotionType.ALLOW_ALL);
    }

    public FrameLayoutWithHole(Activity context, View view, CoachMarkGuide.MotionType motionType) {
        this(context, view, motionType, new Overlay());
    }

    public FrameLayoutWithHole(Activity context, View view, CoachMarkGuide.MotionType motionType, Overlay overlay) {
        super(context);
        mActivity = context;
        mViewHole = view;
        init(null, 0);

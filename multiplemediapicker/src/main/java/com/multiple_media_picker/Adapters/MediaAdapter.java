package com.multiple_media_picker.Adapters;
...
import com.multiple_media_picker.R;
...
public class MediaAdapter extends RecyclerView.Adapter<MediaAdapter.MyViewHolder>{
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        Glide.with(context).load("file://"+bitmapList.get(position)).override(150,150).crossFade().centerCrop().dontAnimate().skipMemoryCache(true).into(holder.thumbnail);

...
public class RangeSeekBar<T extends Number> extends ImageView {
    ...
    private final Bitmap thumbImage = BitmapFactory.decodeResource(getResources(), R.drawable.ic_request_dot_icon);
    private final Bitmap thumbPressedImage = BitmapFactory.decodeResource(getResources(),
                                                                          R.drawable.ic_filter_radio_btn_selected);
    private final Bitmap thumbDisabledImage = BitmapFactory.decodeResource(getResources(),
                                                                           R.drawable.ic_request_dot_icon);
     ...
     */
    public static final int DEFAULT_COLOR = Color.argb(0xFF, 0xEB, 0x2D, 0x7D);
    /**
    ...
    protected synchronized void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int height = (int) (thumbImage.getHeight() + 1.5 * PixelUtil.dpToPx(getContext(), HEIGHT_IN_DP));
...
//                getSelectedMaxValue().equals(getAbsoluteMaxValue()));
        ...
        if (!selectedValuesAreDefault) {
            ...
            canvas.drawText(maxText,
                            ...
                            mDistanceToTop + mTextSize + 2 * thumbWidth,
                            paint);
        }

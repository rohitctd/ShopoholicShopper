 ...
 */
final class ImageCropperWindowMoveHandler {
     ...
     * @param imageCropperCropWindowHandler main crop window handle to get and update the crop window edges
     ...
     */
    public ImageCropperWindowMoveHandler(Type type, ImageCropperCropWindowHandler imageCropperCropWindowHandler, float touchX, float touchY) {
        mType = type;
        mMinCropWidth = imageCropperCropWindowHandler.getMinCropWidth();
        mMinCropHeight = imageCropperCropWindowHandler.getMinCropHeight();
        mMaxCropWidth = imageCropperCropWindowHandler.getMaxCropWidth();
        mMaxCropHeight = imageCropperCropWindowHandler.getMaxCropHeight();
        calculateTouchOffset(imageCropperCropWindowHandler.getRect(), touchX, touchY);
    }

 ...
 */
final class ImageCropperCropWindowHandler {
     ...
     */
    public ImageCropperWindowMoveHandler getMoveHandler(float x, float y, float targetRadius, CropImageView.CropShape cropShape) {
        ImageCropperWindowMoveHandler.Type type = cropShape == CropImageView.CropShape.OVAL
                ? getOvalPressedMoveType(x, y)
                : getRectanglePressedMoveType(x, y, targetRadius);
        return type != null ? new ImageCropperWindowMoveHandler(type, this, x, y) : null;
    }
     ...
     * @return the Handle that was pressed; null if no Handle was pressed
     */
    private ImageCropperWindowMoveHandler.Type getRectanglePressedMoveType(float x, float y, float targetRadius) {
        ImageCropperWindowMoveHandler.Type moveType = null;

        // Note: corner-handles take precedence, then side-handles, then center.
        if (ImageCropperCropWindowHandler.isInCornerTargetZone(x, y, mEdges.left, mEdges.top, targetRadius)) {
            moveType = ImageCropperWindowMoveHandler.Type.TOP_LEFT;
        } else if (ImageCropperCropWindowHandler.isInCornerTargetZone(x, y, mEdges.right, mEdges.top, targetRadius)) {
            moveType = ImageCropperWindowMoveHandler.Type.TOP_RIGHT;
        } else if (ImageCropperCropWindowHandler.isInCornerTargetZone(x, y, mEdges.left, mEdges.bottom, targetRadius)) {
            moveType = ImageCropperWindowMoveHandler.Type.BOTTOM_LEFT;
        } else if (ImageCropperCropWindowHandler.isInCornerTargetZone(x, y, mEdges.right, mEdges.bottom, targetRadius)) {
            moveType = ImageCropperWindowMoveHandler.Type.BOTTOM_RIGHT;
        } else if (ImageCropperCropWindowHandler.isInCenterTargetZone(x, y, mEdges.left, mEdges.top, mEdges.right, mEdges.bottom) && focusCenter()) {
            moveType = ImageCropperWindowMoveHandler.Type.CENTER;
        } else if (ImageCropperCropWindowHandler.isInHorizontalTargetZone(x, y, mEdges.left, mEdges.right, mEdges.top, targetRadius)) {
            moveType = ImageCropperWindowMoveHandler.Type.TOP;
        } else if (ImageCropperCropWindowHandler.isInHorizontalTargetZone(x, y, mEdges.left, mEdges.right, mEdges.bottom, targetRadius)) {
            moveType = ImageCropperWindowMoveHandler.Type.BOTTOM;
        } else if (ImageCropperCropWindowHandler.isInVerticalTargetZone(x, y, mEdges.left, mEdges.top, mEdges.bottom, targetRadius)) {
            moveType = ImageCropperWindowMoveHandler.Type.LEFT;
        } else if (ImageCropperCropWindowHandler.isInVerticalTargetZone(x, y, mEdges.right, mEdges.top, mEdges.bottom, targetRadius)) {
     ...
     * @return the Handle that was pressed; null if no Handle was pressed
     */
    private ImageCropperWindowMoveHandler.Type getOvalPressedMoveType(float x, float y) {
        ...
        */
        ...
        ImageCropperWindowMoveHandler.Type moveType;
        if (x < leftCenter) {
            if (y < topCenter) {
                moveType = ImageCropperWindowMoveHandler.Type.TOP_LEFT;

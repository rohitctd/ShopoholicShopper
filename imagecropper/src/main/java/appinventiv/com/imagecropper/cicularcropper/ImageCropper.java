...
public final class ImageCropper {
    ...
    public static int CROPPER_REQUEST_CODE = 1004;
...
//        }
    ...
    public static final class CropOptionsBuilder {
        ...
        public void start(@NonNull Activity activity) {
            mOptions.validate();
            activity.startActivityForResult(getIntent(activity), CROPPER_REQUEST_CODE);
        }
        ...
        public void start(@NonNull Activity activity, @Nullable Class<?> cls) {
            mOptions.validate();
            activity.startActivityForResult(getIntent(activity, cls), CROPPER_REQUEST_CODE);
        }
        ...
        public void start(@NonNull Context context, @NonNull Fragment fragment) {
            fragment.startActivityForResult(getIntent(context), CROPPER_REQUEST_CODE);
        }
        ...
        public void start(@NonNull Context context, @NonNull Fragment fragment, @Nullable Class<?> cls) {
            fragment.startActivityForResult(getIntent(context, cls), CROPPER_REQUEST_CODE);
        }

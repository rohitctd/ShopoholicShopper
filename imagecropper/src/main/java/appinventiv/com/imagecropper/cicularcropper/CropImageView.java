...
public class CropImageView extends FrameLayout {
     ...
     */
    private final ImageCropperOverlayView mImageCropperOverlayView;
     ...
     */
    private ImageCropperAnimation mAnimation;
    ...
    public CropImageView(Context context, AttributeSet attrs) {
        ...
        ImageCropperOptions options = null;
        ...
        if (options == null) {
            ...
            options = new ImageCropperOptions();
        ...
        mImageCropperOverlayView = (ImageCropperOverlayView) v.findViewById(R.id.CropOverlayView);
        mImageCropperOverlayView.setCropWindowChangeListener(new ImageCropperOverlayView.CropWindowChangeListener() {
            @Override
    ...
    public CropShape getCropShape() {
        return mImageCropperOverlayView.getCropShape();
    }
    ...
    public void setCropShape(CropShape cropShape) {
        mImageCropperOverlayView.setCropShape(cropShape);
    }
    ...
    public boolean isFixAspectRatio() {
        return mImageCropperOverlayView.isFixAspectRatio();
    }
    ...
    public Guidelines getGuidelines() {
        return mImageCropperOverlayView.getGuidelines();
    }
    ...
    public void setGuidelines(Guidelines guidelines) {
        mImageCropperOverlayView.setGuidelines(guidelines);
    }
    ...
    public Pair<Integer, Integer> getAspectRatio() {
        return new Pair<>(mImageCropperOverlayView.getAspectRatioX(), mImageCropperOverlayView.getAspectRatioY());
    }
    ...
    public void setAspectRatio(int aspectRatioX, int aspectRatioY) {
        mImageCropperOverlayView.setAspectRatioX(aspectRatioX);
        mImageCropperOverlayView.setAspectRatioY(aspectRatioY);
    ...
    public void clearAspectRatio() {
        mImageCropperOverlayView.setAspectRatioX(1);
        mImageCropperOverlayView.setAspectRatioY(1);
    ...
    public Rect getCropRect() {
        if (mBitmap != null) {
            ...
            return BitmapUtils.getRectFromPoints(points, orgWidth, orgHeight,
                    mImageCropperOverlayView.isFixAspectRatio(), mImageCropperOverlayView.getAspectRatioX(), mImageCropperOverlayView.getAspectRatioY());
        } else {
            return null;
        }
    }
    ...
    public float[] getCropPoints() {
        ...
        RectF cropWindowRect = mImageCropperOverlayView.getCropWindowRect();
    ...
    public void setCropRect(Rect rect) {
        mImageCropperOverlayView.setInitialCropWindowRect(rect);
    }
    ...
    public void setImageBitmap(Bitmap bitmap) {
        mImageCropperOverlayView.setInitialCropWindowRect(null);
    ...
    public void rotateImage(int degrees) {
        if (mBitmap != null) {
            ...
            boolean flipAxes = !mImageCropperOverlayView.isFixAspectRatio() && ((degrees > 45 && degrees < 135) || (degrees > 215 && degrees < 305));
            BitmapUtils.RECT.set(mImageCropperOverlayView.getCropWindowRect());
            ...
            mImageCropperOverlayView.resetCropOverlayView();
            mImageCropperOverlayView.setCropWindowRect(BitmapUtils.RECT);
            applyImageMatrix(getWidth(), getHeight(), true, false);
            handleCropWindowChanged(false, false);
    ...
    public Parcelable onSaveInstanceState() {
        ...
        bundle.putParcelable("INITIAL_CROP_RECT", mImageCropperOverlayView.getInitialCropWindowRect());
        ...
        bundle.putString("CROP_SHAPE", mImageCropperOverlayView.getCropShape().name());
        ...
        if (state instanceof Bundle) {
            ...
            if (mBitmapLoadingWorkerTask == null && mLoadedImageUri == null && mBitmap == null && mImageResource == 0) {
                ...
                if (initialCropRect != null && (initialCropRect.width() > 0 || initialCropRect.height() > 0)) {
                    mImageCropperOverlayView.setInitialCropWindowRect(initialCropRect);
                }
                ...
                mImageCropperOverlayView.setCropShape(CropShape.valueOf(bundle.getString("CROP_SHAPE")));
        ...
        if (mLayoutWidth > 0 && mLayoutHeight > 0) {
            ...
            if (mBitmap != null) {
                ...
                if (mRestoreCropWindowRect != null) {
                    ...
                    mImageCropperOverlayView.setCropWindowRect(mRestoreCropWindowRect);
                    handleCropWindowChanged(false, false);
                    mImageCropperOverlayView.fixCurrentCropWindowRect();
                    mRestoreCropWindowRect = null;
    ...
    private void handleCropWindowChanged(boolean inProgress, boolean animate) {
        ...
        if (mBitmap != null && width > 0 && height > 0) {
            ...
            RectF cropRect = mImageCropperOverlayView.getCropWindowRect();
            if (inProgress) {
                ...
                if (newZoom > 0 && newZoom != mZoom) {
                    if (animate) {
                        if (mAnimation == null) {
                            ...
                            mAnimation = new ImageCropperAnimation(mImageView, mImageCropperOverlayView);
                        }
    ...
    private void applyImageMatrix(float width, float height, boolean center, boolean animate) {
        if (mBitmap != null && width > 0 && height > 0) {
            ...
            mImageCropperOverlayView.setCropWindowRect(cropRect);
            mapImagePointsByImageMatrix();
            mImageCropperOverlayView.invalidate();
    ...
    private void setCropOverlayVisibility() {
        if (mImageCropperOverlayView != null) {
            mImageCropperOverlayView.setVisibility(mShowCropOverlay && mBitmap != null ? VISIBLE : INVISIBLE);
        }
    }
    ...
    private void updateImageBounds(boolean clear) {
        if (mBitmap != null && !clear) {
            ...
            mImageCropperOverlayView.setCropWindowLimits(getWidth(), getHeight(), scaleFactorWidth, scaleFactorHeight);
        }

        // set the bitmap rectangle and update the crop window after scale factor is set
        mImageCropperOverlayView.setBounds(clear ? null : mImagePoints, getWidth(), getHeight());
    }
    //endregion

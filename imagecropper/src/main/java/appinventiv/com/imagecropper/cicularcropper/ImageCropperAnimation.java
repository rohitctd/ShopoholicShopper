 ...
 */
final class ImageCropperAnimation extends Animation implements Animation.AnimationListener {
    ...
    public ImageCropperAnimation(ImageView cropImageView, ImageCropperOverlayView imageCropperOverlayView) {
        mImageView = cropImageView;
        mImageCropperOverlayView = imageCropperOverlayView;
    ...
    public void setStartState(float[] boundPoints, Matrix imageMatrix) {
        ...
        mStartCropWindowRect.set(mImageCropperOverlayView.getCropWindowRect());
    ...
    public void setEndState(float[] boundPoints, Matrix imageMatrix) {
        ...
        mEndCropWindowRect.set(mImageCropperOverlayView.getCropWindowRect());
    ...
    protected void applyTransformation(float interpolatedTime, Transformation t) {
        ...
        mImageCropperOverlayView.setCropWindowRect(mAnimRect);
        ...
        mImageCropperOverlayView.setBounds(mAnimPoints, mImageView.getWidth(), mImageView.getHeight());
